...
void shapes_and_instructions() {
  ...
  switch (step) {
    ...
    case 6:
      ...
      fill(0, 0, 0); //black color for text
      text("1", width * 0.046,height * 0.08);  // Position the "1" text in the center of the button
      fill(204, 255,255);
      
      triangle(25, 137, 150, 137, 87.5, 45); //#1
      textAlign(CENTER, CENTER); // Ensure text is centered inside the triangle
      fill(0, 0, 0); //black color for text
      text("1", width * 0.046,height * 0.082); // Position the "1" text in the center of the button
      fill(204, 255,255);
    ...
    case 9:
      ...
      text("Next", width * 0.046,height * 0.095); // Position the "1" text in the center of the button
      fill(204, 255,255);
      triangle(1725, 918.5, 1850, 918.5, 1787.5, 826.5);//#2
      textAlign(CENTER, CENTER); // Ensure text is centered inside the triangle
      fill(0, 0, 0); //black color for text
    ...
    case 10:
      ...
      text("Follow the path and click the number", width/2, 1000);
      text("at the end of the path to move forward.", width/2, 1080);
    ...
    case 14:
      background (200,180,200);
      text("Follow the path and click 'Next'             ", width/2, 1000);
      text("at the end of the path to move forward.", width/2, 1080);
    ...
    case 17:
      ...
      textSize(60);
      fill(0);
      text("Follow the path and click the number", width/3.6, 960);
      text("at the end of the path to move forward.", width/3.6, 1040);
      fill(204, 255, 255); //Color of circles ~ Light Blue
